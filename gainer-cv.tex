...
\begin{ressection}{Education}
  \begin{ressubsec}{Brandeis University}{Waltham, MA}{Fall 2007 --- Spring 2012}
    \ressubitem{Ph.D. in mathematics, supervisor Dr.\ Ira Gessel}
  \end{ressubsec}

  \begin{ressubsec}{University of Nebraska IMMERSE}{Lincoln, NE}{Summer 2007}
    \ressubitem{Took short, intensive courses in introductory graduate-level algebra and analysis}
  \end{ressubsec}
...
\begin{ressection}{Academic work experience}
  \begin{ressubsec}{Instructor}{Brandeis Mathematics Department}{Fall 2009}
...
\begin{ressection}{Research}
  ...
  \begin{ressubsec}{$\Gamma$-species, quotients, and graph enumeration}{Brandeis University, Ph.D.\ dissertation, advisor Ira Gessel}{Spring 2012 (expected)}
    ...
    \ressubitem{Enumerated unlabeled general $k$-trees and bipartite blocks using these techniques}
  \end{ressubsec}

  \begin{ressubsec}{On SIL-freedom in random graphs}{Brandeis, minor examination, advisor Ruth Charney}{Fall 2010--Spring 2011}
    \ressubitem{Applied combinatorial methods to study the asymptotics of a graph property related to Dr.\ Charney's ongoing research in geometric group theory}
  \end{ressubsec}
  ...
  \begin{ressubsec}{Virtually cyclic subgroups of 3-dimensional crystallographic groups}{Valparaiso University VERUM (NSF-sponsored REU), advisor Kimberly Pearson}{Summer 2005}
    \ressubitem{As part of a three-undergraduate team, applied algebraic, linear-algebraic, and geometric methods to enumerate the virtually-cyclic subgroups of the three-dimensional crystallographic groups}
...
\begin{ressection}{Departmental service}
  \begin{ressubsec}{Graduate student representative}{Brandeis}{Fall 2008--Spring 2012}
    \ressubitem{Co-coordinated departmental graduate seminar}
    \ressubitem{Co-coordinated semiannual department barbecues}
    \ressubitem{Co-coordinated weekly department tea}
    \ressubitem{Represented graduate students in departmental decision-making including funds allocation and graduate teaching requirements}
  \end{ressubsec}
\end{ressection}
\end{document}
