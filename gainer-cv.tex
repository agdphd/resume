...
\begin{ressection}{Research}
  ...
  \begin{ressubsec}{$\Gamma$-species, Quotients, and Graph Enumeration (Ph.D.\ dissertation)}{Brandeis University}{Spring 2012 (Advisor: Dr.\ I.\ Gessel, Brandeis)}
    \ressubitem{Applied Henderson's theory of $\Gamma$-species to understand group quotients in the context of species theory}
    \ressubitem{Enumerated unlabeled general $k$-trees}
  \end{ressubsec}
