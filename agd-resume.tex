...
\cvitem{\textbf{Java} (1yr)}{
  ...
  These ten thousand lines of code run the gamut from UIs in Swing to a class heirarchy implementing user-selectable alternatives for combinatorial algorithms and include extensive unit tests.
