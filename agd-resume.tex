...
\cvitem{\textbf{Python} (7yr)}{
  ...
  I used the Python-based computer algebra system SageMath for my thesis, including implementing several algebraic objects as classes and submitting bug fixes.
