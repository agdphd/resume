...
I love building useful solutions to challenging problems.
...
\cvitem{\textbf{Math} (10yr+)}{
  ...
  My mathematical training has taught me to solve a problem by finding the right abstractions to break it down into small bits, then using the really big hammers in the literature (and maybe a few of my own invention) to smash them.
